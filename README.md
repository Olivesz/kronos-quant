...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/gates-40%20passing-3fb950" alt="gates">
...
passes a gate on data where the answer is already known.** 40 such gates run in
...
python tests/run_all.py           # all 40 verification gates (~3min)
```
...
- **40 verification gates** — 38 proving an estimator has correct *size*
...
tests/                    40 gates (38 synthetic ground truth + 2 real-data calibration)
