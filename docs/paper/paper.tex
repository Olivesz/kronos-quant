...
Descriptive statistics for the calibration anchor appear in
Table~\ref{tab:calib} (Appendix~\ref{app:battery}) alongside the battery's
threshold definitions; cross-venue descriptive statistics are reported with
the external-validity analysis in Section~\ref{sec:triangle}.
...
and the resulting SEs range from 0.00 to 0.49 events; configurations whose
