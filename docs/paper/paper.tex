...
undigested flow. \citet{filimonov2012} measured near-critical reflexivity in
markets via
...
The classical readings of the equity leverage effect --- firm capital
structure \citep{black1976} and volatility feedback through the equity risk
premium \citep{bekaert2000} --- are equity-specific mechanisms, which is
what makes the cross-venue comparison of Section~\ref{sec:triangle}
informative. Finally, the paper's accounting culture --- trial ledgers,
deflated performance statistics, pre-registered budgets --- follows the
multiple-testing literature in finance \citep{bailey2014, bailey2017}.
...
invalidate range-based variance estimation; a screen measured the fraction
...
notably, a GJR-GARCH process fails E4 --- exponential memory cannot mimic long
