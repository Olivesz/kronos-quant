...
six further indices (Table~\ref{tab:audit} in Appendix~\ref{app:battery})
...
US-calibrated instrument, and its job in this paper is comparative ---
...
thesis --- the wildness channel follows the flow structure of the venue,
...
\paragraph{How far does the 10/10 anchor extend?}
The joint calibration anchor above is one index. A registered audit
